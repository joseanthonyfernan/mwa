...
.button-row button {
    ...
    <div class="container">
        ...
        <div class="footer">
        <p>Remember your password? <a href="https://mcchmhotelreservation.com/admin/login">Login here</a></p>
        </div>
    </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $conn->query("SELECT * FROM tbluseraccount WHERE USER_NAME = '$username'");
    ...
    $conn->query("UPDATE tbluseraccount SET VERIFICATION_TOKEN = '$token', OTP_EXPIRE_AT = '$expires' WHERE USER_NAME = '$username'");
    ...
    try {
        ...
        $mail->Body    = "Click the link below to reset your password:<br><br>
                          <a href='https://mcchmhotelreservation.com/admin/reset_password?token=$token'>Reset Password</a><br><br>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'https://mcchmhotelreservation.com/admin/login'; // Redirect to login page or any other page
            }
        });
    </script>";
    } catch (Exception $e) {
